...
# `macrophage_published_subtype`. In the deposited object the following
# T cell relabels were applied for consistency with manuscript terminology
# (Extended Data Fig. 3c,d):
#   - CD8_Tpex          -> CD8_Checkpoint_high_TRM (matches Fig 5b/Ext Data
#                          Fig 3d "checkpoint-high TRM"; confirmed by markers
#                          LAG3+ TIGIT+ PDCD1+ GZMB-low)
#   - CD8_stressed      -> CD8_Exhausted (matches Ext Data Fig 3d
#                          "Exhausted" cluster; LAG3+TIGIT+CD69-ITGAE-)
#   - CD4_quiescent     -> CD4_naive (matches Fig 5b "naive" terminology)
#   - CD4_Tfh           -> CD4_Memory (pooled; lacked CXCL13)
#   - CD4_Tfr           -> CD4_Treg   (pooled; T follicular regulatory)

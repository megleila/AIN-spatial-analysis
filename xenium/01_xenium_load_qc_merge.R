...
#
# In the deposited object, these original patient IDs have been renumbered
# and de-identified to AIN_01_D through REF_05_D (where _D denotes the
# discovery cohort). The mapping is shown in PRIVATE_xenium_patient_id_mapping
# (not deposited) and is consistent with the IMC discovery cohort IDs.
